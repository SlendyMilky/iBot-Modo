...
class ForumNoDelete(commands.Cog):
    ...
    async def on_raw_message_delete(self, payload):
        try:
            ...
            channel = None
            try:
                # Utilisation de fetch_channel pour récupérer le thread en utilisant l'API Discord
            ...
            # Chercher qui a supprimé le message dans les logs d'audit
            deleter = None
            try:
            ...
            # Créer et envoyer l'embed de notification dans le salon d'info
            ...
            # Vérifiez les permissions à ce stade
            if not info_channel.permissions_for(guild.me).send_messages:
            ...
            # Envoyer l'embed et vérifier les permissions
            try:
